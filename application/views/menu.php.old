    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li>
                        <a href="<?php echo base_url("index.php/congregacao/cadastro"); ?>">
                            <i class="fa fa-circle-o"></i> 
                            Cadastrar
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url("index.php/congregacao/listar"); ?>">
                            <i class="fa fa-circle-o"></i> 
                            Listar/Gerenciar
                        </a>
                    </li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li>
                        <a href="<?php echo base_url("index.php/visitante/cadastro"); ?>">
                            <i class="fa fa-circle-o"></i> 
                            Cadastrar
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url("index.php/visitante/listar"); ?>">
                            <i class="fa fa-circle-o"></i> 
                            Listar/Gerenciar
                        </a>
                    </li>
