...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
			Listar Notícias
            <small>Lista de Notícias Cadastradas</small>
        </h1>
        <ol class="breadcrumb">
          <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
          <li><a href="<?php echo base_url("index.php/slides/listar");?>">Notícias</a></li>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form id="demo-form2"enctype="multipart/form-data" method="POST" action="<?php echo base_url('index.php/site/editarNoticia') ?>">
				<div class="row">
					<div class="col-md-12">
						<div class="col-md-6">
...
<script>
	function getData(cod){
		$.ajax({
			url: "<?php echo base_url("index.php/site/getNoticia");?>",
			datatype: 'json',
			data: {
				cod: cod
			},
